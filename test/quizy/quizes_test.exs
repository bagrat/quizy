defmodule Quizy.QuizesTest do
  ...
  describe "quiz_available?/2 returns" do
    test "true if the requesting user is the owner" do
      owner = user_fixture()
    ...
    test "true if the requesting user is not the owner but the quiz is published" do
      owner = user_fixture()
      quiz = quiz_for_user_fixture(owner)
    ...
    test "false if the requesting user is not the owner and the quiz is not published" do
      owner = user_fixture()
      quiz = quiz_for_user_fixture(owner)
